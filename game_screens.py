...
def draw_play_screen_solo(screen, mouse_pos, logic, particles):
    screen.fill(BG_COLOR)
    draw_glow_text(screen, "TETRIS", title_font, CYAN, 120, 40)
    ...
    # ==========================================
    # HƯỚNG DẪN PHÍM BẤM BÊN DƯỚI RÕ RÀNG HƠN
    # ==========================================
    ...
    pygame.draw.rect(screen, (*CYAN, 120), (left_x, 100, 120, 100), 2, border_radius=4)
    if logic.hold_piece:
    ...
    pygame.draw.rect(screen, (*CYAN, 120), (right_x, 100, 120, 140), 2, border_radius=4)
...
def draw_pvp_screen(screen, mouse_pos, pvp_config, logic1, logic2, particles1, particles2):
    ...
    def draw_player_side(offset_x, player_name, color, logic, controls_lines, particles_list):
        ...
        bg_surface = pygame.Surface((board_w, board_h), pygame.SRCALPHA)
        pygame.draw.rect(bg_surface, (10, 15, 25, 200), bg_surface.get_rect())
        for x in range(logic.cols): pygame.draw.line(bg_surface, (255, 255, 255, 15), (x * PVP_BLOCK_SIZE, 0), (x * PVP_BLOCK_SIZE, board_h))
        for y in range(logic.rows): pygame.draw.line(bg_surface, (255, 255, 255, 15), (0, y * PVP_BLOCK_SIZE), (board_w, y * PVP_BLOCK_SIZE))
        screen.blit(bg_surface, (board_x, board_y))
        ...
        if logic.hold_piece: draw_shape_preview(screen, logic.hold_piece.shape, hold_x + 5, board_y + 10, block_size=10)
        ...
        # ==========================================
        # ĐÃ SỬA: HƯỚNG DẪN PHÍM PVP RÕ RÀNG
        # ==========================================
        ctrl_y = stat_y + 25
    ...
    # Xử lý nội dung hiển thị phím theo Player hoặc AI
